...
Survivors["bill"] <-
{
	...
	Actions = function(hPlayer)
	{
		...
		cvar("st_mr_force_file", "ls2_bill");
...
Survivors["louis"] <-
{
	...
	{
		//SendToServerConsole("st_mr_record 1");
		cvar("st_mr_force_file", "ls2_louis");
...
Survivors["zoey"] <-
{
	...
	{
		//SendToServerConsole("st_mr_record 1");
		cvar("st_mr_force_file", "ls2_zoey");
...
Survivors["francis"] <-
{
	...
	{
		//SendToServerConsole("st_mr_record 1");
		cvar("st_mr_force_file", "ls2_francis");
...
function Callbacks::OnSpeedrunStart() // do some stuff when the countdown is over
{
	...
	*/
	...
	EntFire("worldspawn", "RunScriptCode", "ClientCommand(Ent(\"!zoey\"), \"sm_idle\");", 25.346);
	...
	{
		cvar("host_timescale", 0.5);
		SayMsg("francis walk 24.067 throw 23.533 jump 24.633");
	});

...
Survivors["ellis"] <- 
{
	origin = Vector(6769.150, -1413.406, 24.031) 
	angles = QAngle(3.627, 115.765, 0.000)
	velocity = null
...
Survivors["nick"] <-
{
	origin = Vector(6801.938, -1505.969, 24.031) 
	angles = QAngle(11.669, -64.844, 0.000) 
	velocity = null 
...
//SpawnZombie("boomer", Vector(420.221, -5429.386, 280.031));
		...
		{
SpawnZombie("tank", Vector(-1062.500, -3725.000, 536.031)); 

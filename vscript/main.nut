...
RemoveItemByName("adrenaline");
RemoveItemByName("pain_pills");
RemoveItemByName("upgradepack_explosive");
RemoveItemByName("upgradepack_incendiary");
RemoveItemByName("chainsaw");
RemoveItemByName("grenade_launcher");
